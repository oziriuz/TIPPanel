...
Begin VB.Form setForm2 
   ...
   Begin VB.CheckBox chPrint 
      Caption         =   "Печат на Форма 2  при потвърждението след всяка експедиция"
      Height          =   195
      Left            =   2040
      TabIndex        =   96
      Top             =   7080
   ...
   Begin VB.CheckBox chExpTime 
      ...
      Width           =   255
   End
   Begin VB.Label lblNumSheets 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Брой страници за печат:"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   204
...
Private Sub txtNumSheets_KeyPress(KeyAscii As Integer)
...
Private Sub btnSave_Click()
    ...
    numSheetsForm2 = Me.txtNumSheets.Text
    ...
    If PrevSet = True Then
        ...
        DeleteSetting PlaceProgSettings, PlaceForm2, "Print2"
    End If
    ...
    SaveSetting PlaceProgSettings, PlaceForm2, "Print2", Me.chPrint

'------------------------------Start PostgreSQL----------------------------------
    Set cn = New ADODB.Connection
        cn.ConnectionTimeout = 10
        cn.Open ConStr
    Set rs = cn.Execute("UPDATE settings_soft SET value = '" & Me.txtNumSheets.Text & "' WHERE parameter = 'NumSheetsForm2'")
    rs.Close
    Set rs = Nothing
    cn.Close
    MousePointer = vbDefault
