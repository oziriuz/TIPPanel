...
Begin VB.Form setForm3 
   ...
   Begin VB.CheckBox chPrint 
      Caption         =   "Печат на Форма 3  при потвърждението след всяка експедиция"
      Height          =   195
      Left            =   2040
      TabIndex        =   96
      Top             =   7080
...
Private Sub btnSave_Click()
    ...
    numSheetsForm3 = Me.txtNumSheets.Text
    ...
    If PrevSet = True Then
        ...
        DeleteSetting PlaceProgSettings, PlaceForm3, "Print3"
    End If
    ...
    SaveSetting PlaceProgSettings, PlaceForm3, "Print3", Me.chPrint
...
'------------------------------Start PostgreSQL----------------------------------
    Set cn = New ADODB.Connection
        cn.ConnectionTimeout = 10
        cn.Open ConStr
    Set rs = cn.Execute("UPDATE settings_soft SET value = '" & Me.txtNumSheets.Text & "' WHERE parameter = 'NumSheetsForm3'")
    rs.Close
    Set rs = Nothing
    cn.Close
    MousePointer = vbDefault
